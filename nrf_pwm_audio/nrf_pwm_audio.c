...
uint8_t static const *m_pcm_data= NULL;                                      ///< pointer to the PCM values
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
size_t static pcm_to_pwm(uint16_t *pwm_seq_buffer, uint8_t const *pcm_buffer, size_t pcm_buf_length, nrf_pwm_audio_samplerate_t samplerate, float scaler)
{
